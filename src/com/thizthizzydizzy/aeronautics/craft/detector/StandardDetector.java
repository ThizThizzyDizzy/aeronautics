...
public class StandardDetector extends CraftDetector{
    ...
    public StandardDetector(Aeronautics aeronautics){
        super("aeronautics:standard");
        this.aeronautics = aeronautics;
    }
    @Override
    public CraftDetector newInstance(){
        return new StandardDetector(aeronautics);
    }
    @Override
    ...
    public Craft detect(CraftType type, Player player, Block origin){
        ...
        return new Craft(aeronautics, origin.getWorld(), type, craft);
    }
